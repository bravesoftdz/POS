...
procedure THBeliForm.FormCreate(Sender: TObject);
begin
  inherited;
  conntrading.Close;
    ...
    0 : begin
          ...
          begin
            ...
            begin
              ...
              HBelihbeli.Value := sp_TampilHBeli.Value;
              HBelihpp.Value   := sp_TampilHPP.Value;
              sp_tampil.Next;
            end;
          end;
        end;
    ...
    0 : begin
          ...
          begin
            ...
            begin
              ...
              HBelihbeli.Value   := Querylocal.Fields[2].AsBCD;
              HBelihpp.Value     := Querylocal.Fields[3].AsBCD;
              Querylocal.Next;
            end;
          end;
        end;
