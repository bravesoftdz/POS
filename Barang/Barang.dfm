inherited BarangForm: TBarangForm
  ...
  object Barang: TADODataSet
    ...
    BeforePost = BarangBeforePost
    OnNewRecord = BarangNewRecord
    CommandText = 
    ...
    object BarangBRGID: TStringField
      FieldName = 'BRGID'
      OnValidate = BarangBRGIDValidate
      Size = 30
    end
    ...
    object Baranghjual2: TFMTBCDField
      FieldName = 'hjual2'
      OnValidate = Baranghjual2Validate
      DisplayFormat = '#,###,#0.00'
      Precision = 28
    end
    object Baranghjual3: TFMTBCDField
      FieldName = 'hjual3'
      OnValidate = Baranghjual3Validate
      DisplayFormat = '#,###,#0.00'
      Precision = 28
    end
  ...
  object system_: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'Select CabID From PXSystem')
    Left = 192
    Top = 216
    object system_CabID: TWideStringField
      FieldName = 'CabID'
      Size = 5
    end
  end
