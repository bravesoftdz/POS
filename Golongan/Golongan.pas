...
uses
  ...
  ShellAnimations, XPMan, ExtCtrls, StdCtrls, cxTextEdit;

type
  TGolonganForm = class(TtemplateForm)
    ...
    GolonganTglU: TDateTimeField;
    cxGrid1DBTableView1GolID: TcxGridDBColumn;
...
var
  GolonganForm: TGolonganForm;

implementation

{$R *.dfm}

procedure TGolonganForm.FormCreate(Sender: TObject);
begin
  inherited;
//  mutex := CreateMutex(nil, True, 'GolonganForm');
