...
type
  TSaldoAwalBarangForm = class(TtemplateForm)
    ...
    sp_update_lacc_opname: TADOStoredProc;
    cxGrid1DBTableView1lacc: TcxGridDBColumn;
    sp_Tampillacc: TStringField;
    ...
    procedure lAccExecute(Sender: TObject);
    procedure OpnamelaccValidate(Sender: TField);
  private
    cUser_ : string;
    cPass_ : string;
...
procedure TSaldoAwalBarangForm.lAccExecute(Sender: TObject);
begin
  inherited;
  ...
  begin
     ...
     begin
       Cuser_ :=  LoginForm.edtUserName.Text;
       Cpass_ :=  LoginForm.edtPassword.Text;
       with spUser do
       begin
          close;
          Parameters.ParamByName('userIdIn').Value :=  cUser_;
          Parameters.ParamByName('passin').Value   :=  Cpass_;
          Open;
       end;
       IF not spUser.IsEmpty then
       begin
         if Opnamelacc.Value <> 'T' then
         Begin
           // jalankan sp_approved stok opname
           with sp_update_lacc_opname do
           begin
             close;
             ...
             Parameters.ParamByName('Posisi_').Value:= OpnamePOSISI.Value;
             Parameters.ParamByName('ID_').Value    := cuser_;
             Parameters.ParamByName('stat_').Value  := 'F';
             ExecProc;
           end;
         end else
         begin
           ...
           begin
             ...
             Parameters.ParamByName('Posisi_').Value:= OpnamePOSISI.Value;
             Parameters.ParamByName('ID_').Value    := cuser_;
             Parameters.ParamByName('stat_').Value  := 'T';
             ExecProc;
           end;
         end;
         taTampil.Execute;
  ...
  //      OpnameNOMOR.Value := StrToInt(sp_no_urut_opnamehasil.AsString);
        ...
        begin
          ...
          begin
            ...
            parameters.ParamByName('tempmodify_id').Value := cuser_; // untuk admin
        ...
        begin
          ...
          begin
            ...
            parameters.ParamByName('tempqty').Value := OpnameQTY.AsCurrency;
            parameters.ParamByName('tempposisi').Value := OpnamePOSISI.Value;
            parameters.ParamByName('tempcreateid').Value := cuser_; //untuk admin
            parameters.ParamByName('tempcreatetgl').Value := now;
...
procedure TSaldoAwalBarangForm.OpnamelaccValidate(Sender: TField);
begin
  inherited;
  if Opnamelacc.Value <> 'T' then
  lAcc.Caption := 'Approved' else lAcc.Caption := 'UNApproved';
end;
...
procedure TSaldoAwalBarangForm.taHapusExecute(Sender: TObject);
begin
  inherited;
    ...
    0 : begin
          ...
          begin
            ...
            begin
              ...
              Opnamelacc.Value    := sp_Tampillacc.Value;
              sp_tampil.Next;
            end;
          end;
        end;
    ...
    0 : begin
          ...
          begin
            ...
            begin
              ...
              Opnamelacc.Value    := Querylocal.Fields[6].Value;
              Querylocal.Next;
            end;
          end;
        end;
