inherited SaldoAwalBarangForm: TSaldoAwalBarangForm
  ...
  inherited actlst1: TActionList
    ...
    object lAcc: TAction
      Caption = 'Approved'
      OnExecute = lAccExecute
    end
  end
  object Opname: TADODataSet [9]
  ...
  object Golongan: TADODataSet [12]
    Connection = connTrading
    CursorType = ctStatic
    CommandText = 
  ...
  object connTrading: TADOConnection [14]
    CommandTimeout = 3000
    ConnectionString = 
  ...
  object dsGudang: TDataSource [16]
    DataSet = Gudang
    Left = 136
    Top = 224
  end
  ...
  object dsOpname: TDataSource [19]
    DataSet = Opname
    Left = 136
    Top = 128
  end
  object sp_Tampil: TADOStoredProc [20]
    Connection = connTrading
    CursorType = ctStatic
    CommandTimeout = 300
    ...
    object sp_Tampillacc: TStringField
      FieldName = 'lacc'
      ReadOnly = True
      Size = 1
    end
  end
  object dsItem: TDataSource [21]
    DataSet = Barang
    Left = 200
    Top = 176
  end
  object sp_tampil_satuan: TADOStoredProc [22]
    Connection = connTrading
    CursorType = ctStatic
    CommandTimeout = 300
  ...
  object ds_tampil_Satuan: TDataSource [23]
    DataSet = sp_tampil_satuan
    Left = 376
    Top = 216
  end
  object sp_find_satuan_: TADOStoredProc [24]
    Connection = connTrading
    CursorType = ctStatic
    CommandTimeout = 300
  ...
  object sp_update_lacc_opname: TADOStoredProc
    Connection = connTrading
    CommandTimeout = 300
    ProcedureName = 'sp_update_lacc_opname'
    Parameters = <
      item
        Name = 'BrgID_'
        Attributes = [paNullable]
