...
-- ----------------------------
BEGIN;
INSERT INTO `inbarang` VALUES ('tes', '123', '12', 'NON', '', '', 'PCS', '5.00000000', '1.00000000', '1.00000000', '1.00000000', '1000.00000000', '1000.00000000', '1100.00000000', '1100.00000000', '1100.00000000', '01', '', 'NON', '01', '03', null, '', '0', '', '', '0.00000000', '0.00000000', '0.00000000', null, '02', null, null, '2013-05-26 10:50:18', null, null, null, ''), ('tes123', '123', 'res', 'NON', '', '', 'PSC', '10.00000000', '5.00000000', '1.00000000', '1.00000000', '1000.00000000', '1000.00000000', '1000.00000000', '1000.00000000', '1000.00000000', '01', '', 'NON', '01', '03', null, '', '0', '1234', '', '0.00000000', '0.00000000', '0.00000000', null, '02', null, null, '2013-05-22 22:17:38', null, null, null, ''), ('TESTER', 'Test', '-', 'NON', '', 'BOX', 'PCS', '10.00000000', '5.00000000', '1.00000000', '12.00000000', '12500.00000000', '12500.00000000', '12500.00000000', '12500.00000000', '12500.00000000', '01', '', 'NON', '01', '01', null, '', '0', '-', '', '0.00000000', '0.00000000', '0.00000000', null, '03', null, null, '2013-05-20 22:46:56', null, null, null, '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `inbaranghbeli` VALUES ('tes', '01', '1000.00000000', '1000.00000000', '2013-06-01 08:36:50'), ('tes123', '01', '1000.00000000', '1000.00000000', '2013-06-01 08:36:50'), ('TESTER', '01', '1000.00000000', '1000.00000000', '2013-06-01 08:36:50');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `inbarangopname` VALUES ('01', 'tes', '01', '1', '3', 'PCS', '2.00000000', '0.00000000', '2013-05-31', '', '2013-05-31 23:00:56', null, null, 'SO', 'F', null, null), ('01', 'tes123', '01', '1', '3', 'PSC', '2.00000000', '0.00000000', '2013-05-31', '', '2013-05-31 23:00:56', null, null, 'SO', 'F', null, null), ('01', 'TESTER', '01', '1', '3', 'PCS', '12500.00000000', '0.00000000', '2013-05-31', '', '2013-05-31 23:00:56', null, null, 'SO', 'F', null, null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `pxmerek` VALUES ('01', 'Duxone', '2013-05-13 21:42:13'), ('02', 'DENPO', '2013-05-13 21:56:50');
COMMIT;
...
CREATE TRIGGER `Be4DeleteJenis` BEFORE DELETE ON `pxjenis` FOR EACH ROW Begin       
       ...
       Set JNSID_ = (Select Count(Distinct JeNiSID)  From pxJenis Where EXISTS(Select * From INBarang where Jenis = old.JeNiSID));
       IF JNSID_ = 1 Then
...
CREATE TRIGGER `Be4DeleteMerek` BEFORE DELETE ON `pxmerek` FOR EACH ROW Begin
       ...
       -- Untuk melakukan pengecekan ke table INBarangGudang
       Set MerkID_ = (Select Count(Distinct MRKID)  From pxMerek Where EXISTS(Select * From INBarang where Merek = old.MrkID));
       IF MerkID_ = 1 Then
