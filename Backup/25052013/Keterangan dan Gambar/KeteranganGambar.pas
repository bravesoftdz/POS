...
procedure TKeteranganGambarForm.FormClose(Sender: TObject;
...
begin
  ...
  begin
    close;
    Parameters.ParamByName('pathtemp').Value := INBarangGambarPathGbr.Value;
...
begin
  ...
  INBarangGambarPathGbr.Value := fileDest;
